...
function HeroContent() {
  return (
    <section className="container mx-auto flex flex-col items-center px-8 py-16 sm:flex-row-reverse sm:px-12">
      <div className="mb-8 w-full sm:mb-0 hidden md:block md:pl-16">
...
function Hero({
  ...
  return (
    <div
      className={cn(
        "-mt-[4.2rem] flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800",
        className
      )}
    >
      {children}
